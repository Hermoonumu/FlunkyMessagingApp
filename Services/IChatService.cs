...
{
    public Task CreateNewChatAsync(User owner, ChatDescDTO ncDTO);
    ...
    public Task<List<UserChatsDTO>> GetUserAvailableChats(long UserID);
    ...
    public Task<List<string>> GetChatMembersAsync(User user, long chatID);
}